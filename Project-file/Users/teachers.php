                        ...
                        <li class="nav-item dropdown">
                            <div class="nav-dropdown">
                                <a href="#" id="nav2" class="nav-item nav-link dropdown-toggle text-secondary"
                                    ...
                                    <i class="fas fa-user"></i> <span>Hello </span> <i style="font-size: .8em;"
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="col-md-12 col-lg-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                           ...
                                           <a href="../Users/deleteteacher.php?id= ' . $row["user_id"] . '" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i></a>
                                       </td>
                                        </tr>
                                        ';
                                                    }
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">Teacher Courses</div>
                                <div class="card-body">
